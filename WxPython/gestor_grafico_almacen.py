...
class interfaz(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.sizer.Add(self.titulo, pos=(0, 2),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)
        ### Boton Cerrar ###
        ...
        self.sizer.Add(self.closeButton, pos=(1, 2),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)
        ...
        self.sizer.Add(self.txt_listado, pos=(3, 0),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)
        ...
        self.sizer.Add(self.ctrl_buscar, pos=(5, 0),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)
        ...
        self.sizer.Add(self.cbbox_categoria, pos=(4, 0),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)

        self.ctrl_resultado = wx.TextCtrl(self.pnl, size= (200,600),style = wx.TE_MULTILINE)
        self.sizer.Add(self.ctrl_resultado, pos=(6, 0),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)
        ...
        self.sizer.Add(self.txt_logo1, pos=(0, 1),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)
        ...
        self.sizer.Add(self.txt_logo2, pos=(0, 3),span=wx.DefaultSpan, flag=wx.ALIGN_CENTER)
